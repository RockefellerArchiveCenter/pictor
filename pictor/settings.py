...
# region_name, access_key, secret_key, destination bucket, upload bucket
AWS = (CF.AWS_IIIF_REGION_NAME, CF.AWS_IIIF_ACCESS_KEY, CF.AWS_IIIF_SECRET_KEY, CF.AWS_IIIF_BUCKET, CF.AWS_UPLOAD_BUCKET)
